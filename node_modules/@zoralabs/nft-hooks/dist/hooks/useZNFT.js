...
function useZNFT(id, options = {}) {
    ...
    const nftData = swr_1.default(id ? ['loadZNFTDataUntransformed', id] : null, (_, id) => fetcher.loadZNFTDataUntransformed(id), { refreshInterval, dedupingInterval: 0, initialData });
