...
exports.addAuctionInformation = exports.transformCurrencyForKey = exports.transformMediaForKey = exports.transformCurrencyEth = void 0;
...
function addAuctionInformation(chainNFT, currencyInfos = {}) {
    ...
    const getHighestReserveBid = () => {
        var _a;
        if ((_a = chainNFT.pricing.reserve) === null || _a === void 0 ? void 0 : _a.currentBid) {
    ...
    const getHighestPerpetualBid = () => {
        var _a, _b;
        const sortedBids = (_b = (_a = chainNFT.pricing.perpetual) === null || _a === void 0 ? void 0 : _a.bids) === null || _b === void 0 ? void 0 : _b.map((bid) => ({
            bid,
            computedValue: getCurrencyComputedValue(bid.currency.id, bid.amount),
        })).sort((a, b) => {
            if (a.computedValue && b.computedValue) {
                return new big_js_1.default(a.computedValue.inETH).sub(b.computedValue.inETH) ? -1 : 1;
            }
        ...
        reserve: pricing.reserve
            ? {
                ...
                current: {
                    ...
                    likelyHasEnded: parseInt((_a = chainNFT.pricing.reserve) === null || _a === void 0 ? void 0 : _a.expectedEndTimestamp, 10) <
                        new Date().getTime() / 1000,
                    reserveMet: ((_b = chainNFT.pricing.reserve) === null || _b === void 0 ? void 0 : _b.firstBidTime) &&
