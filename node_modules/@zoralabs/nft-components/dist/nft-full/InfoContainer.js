...
const InfoContainer = ({ children, titleString, bottomPadding = true, }) => {
    ...
    return (jsx_runtime_1.jsxs("div", Object.assign({}, getStyles("infoContainer", { bottomPadding }), { children: [jsx_runtime_1.jsx("div", Object.assign({}, getStyles("fullLabel"), { children: getString(titleString) }), void 0), children] }), void 0));
};
