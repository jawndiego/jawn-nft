...
class MediaFetchAgent {
    ...
    async fetchAuctionNFTInfo(tokenAndAddresses) {
        ...
        const response = (await client.request(zora_1.GET_AUCTION_BY_MEDIA, {
            tokenContract,
            tokenId,
        }));
    ...
    async fetchGenericNFT(nftAddresses) {
        ...
        const response = await fetchWithTimeout.fetch(`${apiBase}assets?${urlParams.join('&')}&order_direction=desc&offset=0&limit=100`);
